            ...
            <footer className="bg-base-300">
                <div className="container flex flex-col items-center justify-between p-6 mx-auto space-y-4 sm:space-y-0 sm:flex-row">
                    <Link href="/" className='flex gap-2 justify-center items-center'>
                        <img className="w-auto h-7 rounded-full" src={logo} alt="logo" />
                        <span className='font-bold'>{import.meta.env.VITE_WEBSITE}</span>
                    </Link>

                    <p className="text-sm ">© Copyright {year}. All Rights Reserved by <span className='font-bold'>{import.meta.env.VITE_WEBSITE}</span> .</p>
